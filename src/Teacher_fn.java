...
public void close()
    ...
    private void initComponents() {
        ...
        username2.setMaximumSize(new java.awt.Dimension(95, 25));
        username2.setMinimumSize(new java.awt.Dimension(95, 25));
        username2.setPreferredSize(new java.awt.Dimension(95, 25));
        ...
        usn.setMaximumSize(new java.awt.Dimension(95, 25));
        usn.setMinimumSize(new java.awt.Dimension(95, 25));
        usn.setPreferredSize(new java.awt.Dimension(95, 25));
        ...
        teamtable.setBounds(30, 120, 620, 310);
    ...
    try {
       pst2=con.prepareStatement(sql);
          ...
          if (rs2.next()){
            ...
            String sql1="select Tm.tm_id,Tm.tm_name,Tm.pid,P.pname from\n"
                    + "project P,team Tm,teacher T\n"
                    + "where P.pid=Tm.pid and Tm.teacher_id=T.teacher_id and T.teacher_id='"+idteacher.getText()+"'";
